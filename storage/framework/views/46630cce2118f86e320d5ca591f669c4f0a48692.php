        ...
        <div class="pizzas">
            ...
            <?php for($i = 0; $i < count($pizzas); $i++): ?>
                <div class="pizza-item">
                    ...
                    <a href="/pizzas/<?php echo e($pizzas[$i]->id); ?>"><?php echo e($pizzas[$i]->name); ?></a>
                </div>   
            <?php endfor; ?>
        </div>
    </div>
...
<?php echo $__env->make('layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Michael\Desktop\pizzahouse\resources\views/pizzas/index.blade.php ENDPATH**/ ?>